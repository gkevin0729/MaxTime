...
Característica: Transacciones bin 6 mediante pos para visa y mastercard retail
  Yo como usuario de banistmo
  Quiero realizar transacciones con tarjetas de bin 6 mendiante pos para visa y mastercard retail
